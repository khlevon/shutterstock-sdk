...
class UsersApi(object):
    ...
    def get_user_subscription_list(self, **kwargs):  # noqa: E501
        """List user subscriptions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_subscription_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_subscription_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_user_subscription_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_user_subscription_list_with_http_info(self, **kwargs):  # noqa: E501
        """List user subscriptions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_subscription_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_subscription_list" % key
                )
            params[key] = val
        del params['kwargs']
